    ...
    {prompts.map((prompt, index) => {
      ...
      return (
        ...
        >
          ...
          <div className="p-2.5 hidden md:block rounded-xl bg-gradient-to-br from-violet-100 to-fuchsia-100 dark:from-violet-900/60 dark:to-fuchsia-900/60 text-violet-600 dark:text-fuchsia-300 shadow-sm transform group-hover:scale-110 transition-transform duration-300">
