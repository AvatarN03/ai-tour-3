...
const HeaderWeather = () => {
    ...
    if (isLoading) {
        return (
            <div className="flex items-center gap-2 bg-accent dark:bg-gray-700 border border-border rounded-md px-3 py-2.5 text-sm opacity-60">
    ...
    return (
        <button
            onClick={getCurrentLocation}
            className="flex items-center gap-1.5 bg-blue-200 dark:bg-gray-700 hover:bg-muted border border-border rounded-md px-3 py-1.5 transition-colors cursor-pointer"
